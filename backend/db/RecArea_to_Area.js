const fs = require('fs')
const recAreas = require('./RecAreas_API_v1.json')
...
// write result to file; use to generate new area seeds
fs.writeFile('./db/RecAreaSeeds.js', JSON.stringify(result), err => {
  if (err) {
    console.error(err)
    return
  }

  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footerRight}>
        <a href='https://github.com/taylorbhogan' target='_blank' rel='noopener noreferrer'>
          <img
        ...
        <a href='https://www.linkedin.com/in/taylorbhogan/' target='_blank' rel='noopener noreferrer'>
          <img
            className={styles.socialLogo}
            alt='LinkedIn Logo'
